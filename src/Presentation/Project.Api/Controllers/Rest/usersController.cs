...
namespace Project.Api.Controllers
{
    ...
    public class usersController : BaseController
    {
        ...
        {
            var command = new AddUserCommand(model.user_name, model.password, model.email, model.phone_number, null);
        ...
        public async Task<ActionResult> Put(Guid id, edit_user_vm model)
        {
            ...
            var command = new EditUserCommand(id, model.user_name, model.email, model.status, model.phone_number, model.role_names);
