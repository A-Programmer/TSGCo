...
namespace Project.Infrastructure.Repositories.UserRepositories
{
    public class UserRepository : Repository<User>, IUserRepository
    {
        ...
        {
            return await Entity.Include(x => x.UserSecurityStamps)
                .Include(x => x.Roles)
        ...
        {
            return await Entity
                .Include(x => x.UserSecurityStamps)
                .FirstOrDefaultAsync(x => x.UserSecurityStamps.FirstOrDefault(s => s.SecurityStamp == securityStamp && s.ExpirationDate > DateTimeOffset.Now) != null);
        }
