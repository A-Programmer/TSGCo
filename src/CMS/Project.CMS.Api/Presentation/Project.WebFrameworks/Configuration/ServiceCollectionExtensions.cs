        ...
        public static void AddSwaggerService(this IServiceCollection services, JwtOptions jwtOptions)
        {
            ...
            services.AddSwaggerGen(options =>
            {
                ...
                options.SwaggerDoc("v1", new OpenApiInfo
                {
                    ...
                    //{
                    //    Name = "MIT",
                    //    Url = new Uri("https://github.com/a-Programmer")
                    //}
                });
                ...
                {
                    Description = @"Please enter username and password (if you don't have clients please ignore client_id and client_secret.",
                    Name = "Authorization",
                    ...
                    Flows = new OpenApiOAuthFlows
                    {
                        ...
                        {
                            TokenUrl = new Uri(jwtOptions.BaseUrl + "/api/v1/signin/login"),
                        }
