...
namespace Project.Api.Controllers
{
    ...
    public class signinController : BaseController
    {
        ...
        public signinController(IMediator mediator, IOptionsSnapshot<PublicSettings> optionsSnapshot)
        {
            _mediator = mediator;
        ...
        public async Task<ActionResult> Login([FromForm] login_vm model)
        {
            ...
            if (loginResult == null)
                return CustomError(Common.Status.BadRequest, "نام کاربری یا کلمه عبور صحیح نمی باشد");
